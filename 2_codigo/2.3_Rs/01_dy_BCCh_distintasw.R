...
# =============================================================================
# Script: 01_dy_BCCh_distintasw.R
...
# Por favor, setear ruta en "ruta" y luego ejecutar codigo.
library(fs)
ruta <- path("../..")
ruta_input  <- ruta / "1_datos/1_clean_data"
ruta_output <- ruta / "3.2_resultado_dy/salidas_distintasw"
# =============================================================================
...
p_tci <- ggplot(df_tci_rw, aes(x = fecha, y = tci, color = ventana, linetype = ventana)) +
  ...
  )  +  scale_color_manual(values = c("W=32" = "gray50", "W=34" = "steelblue", "W=36" = "forestgreen")) +
...
# Guardar graficos
ggsave(file.path(ruta_output, "figs", "bcch_01_tci_rolling_distintasw.png"),  p_tci,  width = 10, height = 6, dpi = 150)
ggsave(file.path(ruta_output, "figs", "bcch_02_net_rolling_distintasw.png"),  p_net,  width = 10, height = 8, dpi = 150)
ggsave(file.path(ruta_output, "figs", "bcch_03_to_rolling_distintasw.png"),   p_to,   width = 10, height = 8, dpi = 150)
ggsave(file.path(ruta_output, "figs", "bcch_04_from_rolling_distintasw.png"), p_from, width = 10, height = 8, dpi = 150)
